...
[out_bubbletemp_silhouette,output_bubbletemp_face] = raytrace_adjust(input_bubbletemp_silhouette,input_bubbletemp_face)    %根据气泡图像和LED的信息来更新光线追踪的结果
for ray_count = 1:100
    ray_number = 100;  
    ...
    raypoint_at_LED = intersectLinePlane(input_bubbletemp_silhouette,...
        o1_temp_ray,planeNormal_LED,planePoint_LED);%q点初步由o1与LED面交点求得
    ...
    %通过单根射线的追踪即可满足气泡前面的确定
        ...
        out_bubbletemp_silhouette = [input_bubbletemp_silhouette(1,1),input_bubbletemp_silhouette(1,2),d1_length_temp_ray];
